...
python -W ignore testixi_dist.py --upscale 2 --lr_slice_patch 4  --testdata_path /home/konata/Dataset/IXI-T2/I3Net/imagesTs --gpu_id '0' --model 'mamba_unet_x3'  --ckpt experiments/mamba_unetx3/IXI_x2_test/pth/0500.pth --ckpt_dir IXI_x2_test  --num_workers 4
