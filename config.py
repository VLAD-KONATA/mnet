...
data_arg.add_argument('--traindata_path', type=str, default='/home/konata/Dataset/IXI-T2/I3Net/slice')
data_arg.add_argument('--testdata_path', type=str, default='/home/konata/Dataset/IXI-T2/I3Net/imagesTs')
