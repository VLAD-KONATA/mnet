...
class IntraSliceBranch(nn.Module):
    def __init__(self,conv=nn.Conv2d,n_feat=64,kernel_size=3,bias=True,
        ...
        self.attn = nn.Sequential(
            ...
            PreNormResidual(dim=n_feat, fn=FeedForward(dim=16**2, expansion_factor=1, dropout=0, dense=chan_first)), # dim=num_patch
