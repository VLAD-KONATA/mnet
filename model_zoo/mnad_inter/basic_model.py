...
from ..mnet.Memory import Memory
from ..mnet.Reconstruction import convAE
...
class newmodel(nn.Module):
    def __init__(self,args=None,conv=default_conv):
        ...
        self.inter_slice = nn.Sequential(*inter_slice_branch)
        self.sr=None
