python -W ignore main.py \
    ...
    python -W ignore main.py --upscale 2 --lr_slice_patch 4 --traindata_path /home/konata/Dataset/IXI-T2/I3Net/slice --testdata_path /home/konata/Dataset/IXI-T2/I3Net/imagesTs --ckpt_dir IXI_x2 --batch_size 4 --gpu_id '0' --model 'mamba_unet_contract' --num_workers 4
    python -W ignore main.py --upscale 2 --lr_slice_patch 4 --traindata_path /home/konata/Dataset/IXI-T2/I3Net/slice --testdata_path /home/konata/Dataset/IXI-T2/I3Net/imagesTs --ckpt_dir IXI_x2 --batch_size 4 --gpu_id '0' --model 'mamba_unet_x3' --num_workers 4
    python -W ignore main.py --upscale 2 --lr_slice_patch 4 --traindata_path /home/konata/Dataset/IXI-T2/I3Net/slice --testdata_path /home/konata/Dataset/IXI-T2/I3Net/imagesTs --ckpt_dir IXI_x2 --batch_size 4 --gpu_id '0' --model 'unet(mamba+dwconv+wave)' --num_workers 4
